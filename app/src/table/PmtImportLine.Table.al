table 5157809 "Pmt. Import Line"
{
    ...
    fields
    {
        ...
        field(66; "Accounted by"; Option)
        {
            ...
            DataClassification = SystemMetadata;
            Editable = false;
            OptionCaption = ',BC Code,Accounting Rule,Bank Account,Account No.,Document No.,Sales Order,Purch. Order,Ext. Document No.,Pmt. Transaction,EREF,Reminder,Sales Shipment,Imported C/V Bankaccount';
            OptionMembers = ,"BC Code","Accounting Rule","Bank Account","Account No.","Document No.","Sales Order","Purch. Order","Ext. Document No.","Pmt. Transaction",EREF,Reminder,"Sales Shipment","Imported C/V Bankaccount";
        }
        ...
        field(103; "Exchange Rate Origin Amount"; Decimal)
        {
            Caption = 'Exchange Rate Origin Amount';
            DataClassification = SystemMetadata;
            DecimalPlaces = 1 : 6;
        }
        field(104; "Imported Description"; Text[50])
        {
            Caption = 'Imported Description';
            DataClassification = SystemMetadata;
        }
        field(105; "Changed by User"; Boolean)
        {
    ...
    keys
    {
        ...
        key(Key2; "Import Register No.", Posted)
        {
    ...
    procedure FillLineNo(_PmtImportLine: Record "Pmt. Import Line")
    begin
    end;

    procedure SavePmtImportLineDim(FieldNumber: Integer; ShortcutDimCode: Code[20]; var PmtImportLine: Record "Pmt. Import Line")
    begin
    end;

    procedure ValidateDimValueCode(FieldNumber: Integer; ShortcutDimCode: Code[20])
    begin
    end;

    procedure LookupDimValueCode(FieldNumber: Integer; ShortcutDimCode: Code[20])
    begin
    end;
}